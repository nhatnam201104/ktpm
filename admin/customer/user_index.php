...
$sql = "select user.*, Role.name as role_name from user left join Role on User.role_id = Role.id where user.role_id=5";
...
<div class="row" style="margin-top: 20px;">
    <div class="col-md-12 table-responsive">
        <h1 class=" badge-pill badge-primary" style="display:flex;justify-content: center;padding: 10px;">Quản Lý Khách Hàng</h1>
        <input type="text" id="searchPhone" class="form-control" style="margin-bottom: 20px;" placeholder="Tìm theo SĐT" onkeyup="searchTable()">
        <a href="editor.php"><button class="btn btn-success">Thêm Khách Hàng</button></a>
...
<script type="text/javascript">
    ...
    function searchTable() {
        ...
        for (let i = 0; i < rows.length; i++) {
            let phoneCell = rows[i].getElementsByTagName("td")[2]; // Cột SĐT (chỉ số 2)
            if (phoneCell) {
