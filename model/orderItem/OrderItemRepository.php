...
class OrderItemRepository{
	...
	function save($data) {
		...
		$sql = "INSERT INTO order_item (product_id, order_id, qty, unit_price, total_price, batch_id) VALUES ($product_id, $order_id, $qty, $unit_price, $total_price, $batch_id)";
		if ($conn->query($sql) === TRUE) {
			$sql1 = "UPDATE entry_details 
			SET p_inventory = p_inventory - $qty 
			WHERE product_id = $product_id AND entercoupon_id = $batch_id";
